...
Route::get('/mailable/user/create', function(){
    $user = App\User::find(1);
    return new App\Mail\LoginCredentials($user, '123456');
});


Route::get('/mailable/comment/create', function(){
    $post = App\Post::find(1);
    return new App\Mail\NewComment($post, 'Un comentario 1');
});
...
/*Route::get('email', function(){    mailtrap
...
Route::group(['middleware' => 'auth'], function(){
    ...
    Route::post('comments/{post}', 'PagesController@comment')->name('pages.comment.store');
